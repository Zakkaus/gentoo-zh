...
# Upstream dropped the cloud Hoppscotch_linux_x64.deb after v26.6.0-0; the SelfHost
# build is the only remaining linux .deb, same file layout.
MY_PV=$(ver_rs 3 '-')
SRC_URI="https://github.com/hoppscotch/releases/releases/download/v${MY_PV}/Hoppscotch_SelfHost_linux_x64.deb -> ${P}.deb"
